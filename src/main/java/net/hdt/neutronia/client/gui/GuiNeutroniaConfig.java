...
public class GuiNeutroniaConfig extends GuiScreen {
	...
	private ArrayList<ModuleFold> modules = new ArrayList<ModuleFold>();

	public GuiNeutroniaConfig(GuiScreen parent) {
		this.parent = parent;
		for(int i = 0; i < 10; i++) {
			ModuleFold fold = new ModuleFold("Test Module " + i, "Quandoque ut motus perfidia tractibus ut delictis delictis agitat primordiis aeternam supra apud eo insperatos regis quam cuncta temptentur nocitura.");
