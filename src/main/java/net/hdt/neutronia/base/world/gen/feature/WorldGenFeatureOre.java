...
public class WorldGenFeatureOre extends WorldGenFeature {
    private IBlockState blockToSpawn;
    private IBlockState blockToReplace;
    private int veinSize;

    public WorldGenFeatureOre(Config config) {
        super(config);
    ...
    public WorldGenFeatureOre(int genAttempts, float genProbability, boolean randomizeGenAttempts, int minGenHeight, int maxGenHeight, IBlockState blockToSpawn, IBlockState blockToReplace, int veinSize) {
