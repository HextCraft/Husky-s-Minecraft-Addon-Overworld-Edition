...
import net.hdt.neutronia.base.util.BlockHelper;
import net.hdt.neutronia.base.util.Config;
import net.hdt.neutronia.base.util.NumberHelper;
...
public class WorldGenFeatureOakTree extends WorldGenFeature {
    ...
    public WorldGenFeatureOakTree(int genAttempts, float genProbability, boolean randomizeGenAttempts, int minGenHeight, int maxGenHeight, IBlockState logBlock, IBlockState leafBlock, int minGrowthHeight, int maxGrowthHeight) {
