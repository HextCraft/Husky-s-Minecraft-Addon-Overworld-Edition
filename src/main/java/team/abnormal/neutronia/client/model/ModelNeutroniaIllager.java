...
public class ModelNeutroniaIllager extends ModelBase
{
    ...
    public ModelNeutroniaIllager(float scaleFactor, float p_i47227_2_, int textureWidthIn, int textureHeightIn)
    {
