...
public class NSoundEvents {
    ...
    public static final SoundEvent ENTITY_FISH_HURT = new SoundEvent(new ResourceLocation(Reference.MOD_ID, "entity.fish.hurt"));
    public static final SoundEvent ENTITY_FISH_DEATH = new SoundEvent(new ResourceLocation(Reference.MOD_ID, "entity.fish.death"));
