...
public class WhiteDesertBiome extends Biome {

    public WhiteDesertBiome() {
        super(new BiomeProperties("White Desert").setRainfall(0.0F).setTemperature(2.0F).setBaseHeight(Biomes.DESERT.getBaseHeight()).setHeightVariation(Biomes.DESERT.getHeightVariation()).setRainDisabled().setWaterColor(0xcaba8a));
        this.spawnableCreatureList.clear();
        this.topBlock = NBlocks.WHITE_SAND.getDefaultState();
        this.fillerBlock = NBlocks.WHITE_SAND.getDefaultState();
