...
public class SilverMesaBiome extends Biome {
    ...
    protected static final IBlockState HARDENED_CLAY = Blocks.STAINED_HARDENED_CLAY.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.WHITE);
    ...
    protected static final IBlockState ORANGE_STAINED_HARDENED_CLAY = STAINED_HARDENED_CLAY.withProperty(BlockColored.COLOR, EnumDyeColor.LIGHT_BLUE);
    protected static final IBlockState BLACK_SAND = NBlocks.WHITE_SAND.getDefaultState();
    ...
    public SilverMesaBiome(boolean brycePillars, boolean hasForest, BiomeProperties properties) {
        super(properties);
        this.brycePillars = brycePillars;
        this.hasForest = hasForest;
        this.spawnableCreatureList.clear();
        this.topBlock = BLACK_SAND;
    ...
    {
        return new SilverMesaBiome.Decorator();
    }
    ...
    public void generateBands(long p_150619_1_)
    {
        ...
        for (int i = 0; i < i2; ++i)
        {
            ...
            {
                this.clayBands[k + l] = STAINED_HARDENED_CLAY.withProperty(BlockColored.COLOR, EnumDyeColor.LIGHT_BLUE);
            }
        }
        ...
        for (int k2 = 0; k2 < j2; ++k2)
        {
            ...
            {
                this.clayBands[l3 + i1] = STAINED_HARDENED_CLAY.withProperty(BlockColored.COLOR, EnumDyeColor.SILVER);
            }
        }
        ...
        for (int j3 = 0; j3 < l2; ++j3)
        {
            ...
            {
                this.clayBands[k4 + j1] = STAINED_HARDENED_CLAY.withProperty(BlockColored.COLOR, EnumDyeColor.WHITE);
            }
        }
        ...
        for (int l4 = 0; l4 < k3; ++l4)
        {
            ...
            {
                this.clayBands[j4 + k1] = STAINED_HARDENED_CLAY.withProperty(BlockColored.COLOR, EnumDyeColor.CYAN);
            }
        }
    }

    public IBlockState getBand(int p_180629_1_, int p_180629_2_)
    {
