...
public class BlueMesaBiome extends Biome {
    ...
    protected static final IBlockState HARDENED_CLAY = Blocks.STAINED_HARDENED_CLAY.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.BLACK);
    protected static final IBlockState STAINED_HARDENED_CLAY = Blocks.STAINED_HARDENED_CLAY.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.PURPLE);
    protected static final IBlockState ORANGE_STAINED_HARDENED_CLAY = STAINED_HARDENED_CLAY.withProperty(BlockColored.COLOR, EnumDyeColor.BLUE);
    protected static final IBlockState BLACK_SAND = NBlocks.BLACK_SAND.getDefaultState();
    ...
    public BlueMesaBiome(boolean brycePillars, boolean hasForest, BiomeProperties properties) {
        super(properties);
    ...
    {
        return new BlueMesaBiome.Decorator();
    }
    ...
    public void generateBands(long p_150619_1_)
    {
        ...
        for (int k2 = 0; k2 < j2; ++k2)
        {
            ...
            {
                this.clayBands[l3 + i1] = STAINED_HARDENED_CLAY.withProperty(BlockColored.COLOR, EnumDyeColor.PURPLE);
            }
        }
        ...
        for (int l4 = 0; l4 < k3; ++l4)
        {
            ...
            {
                this.clayBands[j4 + k1] = STAINED_HARDENED_CLAY.withProperty(BlockColored.COLOR, EnumDyeColor.GRAY);
            }
        }
    }
