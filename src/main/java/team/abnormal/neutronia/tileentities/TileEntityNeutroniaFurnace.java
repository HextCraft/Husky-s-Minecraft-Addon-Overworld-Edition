...
import team.abnormal.neutronia.blocks.BlockNeutroniaFurnace;

public class TileEntityNeutroniaFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityNeutroniaFurnace.class, new String[] {"Items"}));
    }
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockNeutroniaFurnace.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    {
        return "neutronia:furnace";
    }

    public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn)
    {
        return new team.abnormal.neutronia.inventory.ContainerFurnace(playerInventory, this);
    }
