...
import team.abnormal.neutronia.blocks.BlockSmoker;
import team.abnormal.neutronia.inventory.ContainerSmoker;
import team.abnormal.neutronia.inventory.SlotBlastFurnaceFuel;
import team.abnormal.neutronia.items.crafting.SmokerRecipes;
...
public class TileEntitySmoker extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    /** The number of ticks that a fresh opy of the currently-burning item would keep the furnace burning for */
     ...
     * <dl>
     * <dt> </dt>
     * <dd>Returns the name of this inventory. If this then this <em>should</em> be a direct string; otherwise it <em>should</em> be a valid translation
     * string.</dd>
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "inventory.smoker";
    }
    ...
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntitySmoker.class, "Items"));
    }
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockSmoker.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = SmokerRecipes.instance().getSmeltingResult(this.furnaceItemStacks.get(0));
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            ItemStack itemstack1 = SmokerRecipes.instance().getSmeltingResult(itemstack);
