...
public class BlastingRecipes extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<IRecipe> implements net.minecraftforge.common.crafting.IShapedRecipe
{
    ...
    public BlastingRecipes(String group, int width, int height, NonNullList<Ingredient> ingredients, ItemStack result)
    {
        this.group = group;
     ...
     */
    public static BlastingRecipes deserialize(JsonObject json)
    {
        ...
        return new BlastingRecipes(s, i, j, nonnulllist, itemstack);
    }
