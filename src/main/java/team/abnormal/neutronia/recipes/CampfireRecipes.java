...
public class CampfireRecipes extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<IRecipe> implements net.minecraftforge.common.crafting.IShapedRecipe
{
    ...
    public CampfireRecipes(String group, int width, int height, NonNullList<Ingredient> ingredients, ItemStack result)
    {
        this.group = group;
     ...
     */
    public static CampfireRecipes deserialize(JsonObject json)
    {
        ...
        return new CampfireRecipes(s, i, j, nonnulllist, itemstack);
    }
