...
public class SmokingRecipes extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<IRecipe> implements net.minecraftforge.common.crafting.IShapedRecipe
{
    ...
    public SmokingRecipes(String group, int width, int height, NonNullList<Ingredient> ingredients, ItemStack result)
    {
        this.group = group;
     ...
     */
    public static SmokingRecipes deserialize(JsonObject json)
    {
        ...
        return new SmokingRecipes(s, i, j, nonnulllist, itemstack);
    }
