...
public abstract class Registry<T> implements IntIterable<T> {
   ...
   static {
      ...
      for (ModifiableRegistry<?> modifiableRegistry_1 : REGISTRIES) {
         ...
         if (modifiableRegistry_1 instanceof DefaultMappedRegistry) {
            ...
            Validate.notNull(modifiableRegistry_1.get(identifier_1), "Missing default of DefaultedMappedRegistry: " + identifier_1);
         }
      }
   }
}
