package team.hdt.neutronia.groups.world.world.gen.structures;
    ...
    public static class MansionTemplate extends StructureComponentTemplate
        {
            ...
            {
                Template template = p_191081_1_.getTemplate(null, new ResourceLocation("neutronia","mansion/" + /*this.woodType + "_" + */this.templateName));
