...
public class BlackDesertBiome extends Biome {
    ...
    public BlackDesertBiome() {
        super(new BiomeProperties("Black Desert").setRainfall(0.0F).setTemperature(2.0F).setBaseHeight(Biomes.DESERT.getBaseHeight()).setHeightVariation(Biomes.DESERT.getHeightVariation()).setRainDisabled().setWaterColor(0xcaba8a));
        this.spawnableCreatureList.clear();
        this.topBlock = NBlocks.BLACK_SAND.getDefaultState();
        this.fillerBlock = NBlocks.BLACK_SAND.getDefaultState();
