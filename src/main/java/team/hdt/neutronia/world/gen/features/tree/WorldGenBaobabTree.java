package team.hdt.neutronia.world.gen.features.tree;
...
public class WorldGenBaobabTree extends WorldGenHugeTrees {
    ...
    public WorldGenBaobabTree(boolean notify, int baseHeightIn, int extraRandomHeightIn, IBlockState log, IBlockState leaf) {
        super(notify, baseHeightIn, extraRandomHeightIn, log, leaf);
    }

    public WorldGenBaobabTree(IBlockState log, IBlockState leaf) {
        this(true, 15, 6, log.withProperty(BlockLog.AXIS, EnumFacing.Axis.Y), leaf.withProperty(BlockLeaves.CHECK_DECAY, false));
    }
