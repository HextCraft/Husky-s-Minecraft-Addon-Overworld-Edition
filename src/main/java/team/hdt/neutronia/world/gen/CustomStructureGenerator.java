package team.hdt.neutronia.world.gen;
...
import team.hdt.neutronia.world.gen.features.StructureFeature;
...
public class CustomStructureGenerator implements IWorldGenerator {
    ...
    private static final StructureFeature SPRUCE_BUILDS = new StructureFeature(Lists.newArrayList("Tavern", "tyruswoo/megataigatreehouse01", "tyruswoo/megataigatreehouse02"));
    private static final StructureFeature RANDOM = new StructureFeature(Lists.newArrayList("tyruswoo/beachtree01", "tyruswoo/beachtree02", "tyruswoo/beachtree03", "tyruswoo/beachtree04", "tyruswoo/beachtree05", "tyruswoo/beachtree06", "tyruswoo/beachtree07", "tyruswoo/beachtree08", "tyruswoo/beachtree09", "tyruswoo/beachtree10"));
