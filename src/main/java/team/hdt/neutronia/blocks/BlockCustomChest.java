...
import team.hdt.neutronia.items.ItemChestBlock;
import team.hdt.neutronia.properties.ChestType;
...
public class BlockCustomChest extends BlockChest implements INeutroniaBlock {
    ...
    public BlockCustomChest(String name, Type type) {
        ...
        setCreativeTab(type == CUSTOM_TYPE_NEUTRONIA_TRAP ? CreativeTabs.REDSTONE : CreativeTabs.DECORATIONS);
    }
    ...
    public boolean canProvidePower(IBlockState state) {
        return chestType == CUSTOM_TYPE_NEUTRONIA_TRAP;
    }
