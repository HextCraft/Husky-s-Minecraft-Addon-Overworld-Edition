...
public class Referece {
    ...
    // Proxy Constants
    public static final String PROXY_COMMON = "team.hdt.neutronia_revamped.proxy.CommonProxy";
    public static final String PROXY_CLIENT = "team.hdt.neutronia_revamped.proxy.ClientProxy";
