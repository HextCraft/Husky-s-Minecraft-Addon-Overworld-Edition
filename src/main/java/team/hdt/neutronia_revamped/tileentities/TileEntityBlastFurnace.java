...
import team.hdt.neutronia_revamped.blocks.BlockBlastFurnace;
import team.hdt.neutronia_revamped.inventory.ContainerBlastFurnace;
import team.hdt.neutronia_revamped.inventory.SlotBlastFurnaceFuel;
import team.hdt.neutronia_revamped.items.crafting.BlastFurnaceRecipes;
...
public class TileEntityBlastFurnace extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "inventory.blastFurnace";
    }
    ...
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityBlastFurnace.class, "Items"));
    }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = BlastFurnaceRecipes.instance().getSmeltingResult(this.furnaceItemStacks.get(0));
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            ItemStack itemstack1 = BlastFurnaceRecipes.instance().getSmeltingResult(itemstack);
    ...
    {
        return "neutronia_revamped:blast_furnace";
    }
