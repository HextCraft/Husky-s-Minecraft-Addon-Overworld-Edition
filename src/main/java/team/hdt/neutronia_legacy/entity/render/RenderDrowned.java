...
import team.hdt.neutronia_legacy.entity.EntityDrowned;
import team.hdt.neutronia_legacy.entity.render.layer.LayerDrownedOuter;

@SideOnly(Side.CLIENT)
public class RenderDrowned extends RenderBiped<EntityDrowned> {

    private static final ResourceLocation MUMMY_TEXTURE = new ResourceLocation("neutronia_legacy:textures/entity/sea/drowned/drowned.png");
