...
import team.hdt.neutronia_legacy.entity.EntitySandDiverAquatic;
import team.hdt.neutronia_legacy.entity.render.RenderSandDiverAquatic;

@SideOnly(Side.CLIENT)
public class LayerSanddiverAquaticGlow implements LayerRenderer<EntitySandDiverAquatic> {

    private static final ResourceLocation GLOWING_TEXTURE = new ResourceLocation("neutronia_legacy:textures/entity/sanddiver_aquatic_glow.png");
