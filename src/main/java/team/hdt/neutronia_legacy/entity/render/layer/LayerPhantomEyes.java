...
import team.hdt.neutronia_legacy.entity.render.RenderPhantom;

@SideOnly(Side.CLIENT)
public class LayerPhantomEyes implements LayerRenderer<EntityPhantom> {

    private static final ResourceLocation PHANTOM_EYES_TEXTURES = new ResourceLocation("neutronia_legacy:textures/entity/phantom/phantom_eyes.png");
