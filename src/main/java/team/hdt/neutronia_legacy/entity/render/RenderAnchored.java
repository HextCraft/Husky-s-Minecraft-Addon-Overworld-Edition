...
import team.hdt.neutronia_legacy.entity.EntityAnchored;
import team.hdt.neutronia_legacy.entity.render.layer.LayerDiverSuit;

@SideOnly(Side.CLIENT)
public class RenderAnchored extends RenderBiped<EntityAnchored> {

    private static final ResourceLocation MUMMY_TEXTURE = new ResourceLocation("neutronia_legacy:textures/entity/sea/diver/diver.png");
