...
import team.hdt.neutronia_legacy.entity.EntityLostMiner;

@SideOnly(Side.CLIENT)
public class RenderLostMiner extends RenderBiped<EntityLostMiner> {

    private static final ResourceLocation MUMMY_TEXTURE = new ResourceLocation("neutronia_legacy:textures/entity/miner/lost_miner.png");
