...
import team.hdt.neutronia_legacy.entity.render.RenderInferno;

@SideOnly(Side.CLIENT)
public class LayerInfernoActiveGlow implements LayerRenderer<EntityInferno> {

    private static final ResourceLocation GLOWING_TEXTURE = new ResourceLocation("neutronia_legacy:textures/entity/inferno_active_glow.png");
