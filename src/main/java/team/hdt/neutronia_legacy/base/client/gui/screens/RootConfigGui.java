...
import team.hdt.neutronia_legacy.base.client.gui.ConfigCategory;
import team.hdt.neutronia_legacy.base.client.gui.GuiConfigBase;
import team.hdt.neutronia_legacy.base.client.gui.GuiConfigGroup;
import team.hdt.neutronia_legacy.base.client.gui.elements.ColoredButton;
import team.hdt.neutronia_legacy.base.client.gui.elements.ConfigSettingsButton;
import team.hdt.neutronia_legacy.base.client.gui.elements.GroupButton;
...
public class RootConfigGui extends GuiConfigBase {
    ...
    private void addFeatureButtons() {
        ...
        x = width / 2;
        y = startY + 117;
        buttonList.add(new ConfigSettingsButton(x + 85, y + 22, GlobalConfig.NButtonProp, true, I18n.translateToLocal("neutronia_legacy.config.enableq")));
        buttonList.add(new GuiButton(1, x - 100, y + 22, 98, 20, I18n.translateToLocal("neutronia_legacy.config.general")));
//        buttonList.add(new GuiButton(2, x  + 2, y + 22, 98, 20, I18n.translateToLocal("neutronia_legacy.config.import")));

//        buttonList.add(new CustomIconButton(3, x - 100, y + 44, 0, 0, 20, 20, CUSTOM_BUTTON_ICONS/*, I18n.translateToLocal("neutronia_legacy.config.opensite")*/));
//        buttonList.add(new CustomIconButton(4, x - 40, y + 44, 0, y + 44, 20, 20, CUSTOM_BUTTON_ICONS/*, I18n.translateToLocal("neutronia_legacy.config.discord")*/));
//        buttonList.add(new CustomIconButton(5, x + 36, y + 44, 0, y + 44 + 44, 20, 20, CUSTOM_BUTTON_ICONS/*, I18n.translateToLocal("neutronia_legacy.config.twitter")*/));
        buttonList.add(new ColoredButton(3, x - 100, y + 44, 54, I18n.translateToLocal("neutronia_legacy.config.opensite"), 0x4078c0));
        buttonList.add(new ColoredButton(5, x - 40, y + 44, 54, I18n.translateToLocal("neutronia_legacy.config.discord"), 0x7289da));
        buttonList.add(new ColoredButton(5, x + 36, y + 44, 54, I18n.translateToLocal("neutronia_legacy.config.twitter"), 0x55acee));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (mayRequireRestart)
            s = I18n.translateToLocal("neutronia_legacy.config.needrestart");
        else if (nEnabled && !GlobalConfig.enableNButton)
            s = I18n.translateToLocal("neutronia_legacy.config.qdisabled");
