...
public class GroupButton extends GuiButton {
    ...
    public GroupButton(int x, int y, Group group) {
        super(0, x, y, 150, 20, I18n.translateToLocal("neutronia_legacy.config.group." + group.getName().toLowerCase().replace(" ", "_")));
        this.group = group;
    }

    public GroupButton(int id, int x, int y, int width, int height, Group group) {
        super(id, x, y, width, height, I18n.translateToLocal("neutronia_legacy.config.group." + group.getName().toLowerCase().replace(" ", "_")));
        this.group = group;
    }
