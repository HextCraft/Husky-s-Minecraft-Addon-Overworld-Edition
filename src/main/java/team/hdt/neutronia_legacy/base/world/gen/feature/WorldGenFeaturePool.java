...
public class WorldGenFeaturePool extends WorldGenFeature {
    private IBlockState blockToSpawn;
    private IBlockState blockToSurround;

    public WorldGenFeaturePool(Config config) {
        super(config);
    ...
    public WorldGenFeaturePool(int genAttempts, float genProbability, boolean randomizeGenAttempts, int minGenHeight, int maxGenHeight, IBlockState blockToSpawn, IBlockState blockToSurround) {
