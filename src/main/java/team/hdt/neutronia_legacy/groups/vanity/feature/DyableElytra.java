...
import team.hdt.neutronia_legacy.groups.vanity.client.layer.LayerBetterElytra;
import team.hdt.neutronia_legacy.groups.vanity.recipes.ElytraDyingRecipe;
...
public class DyableElytra extends Component {
    ...
    public static final String TAG_ELYTRA_DYE = "neutronia_legacy:elytraDye";
    ...
    public void onTooltip(ItemTooltipEvent event) {
        ...
        if (!stack.isEmpty() && stack.getItem() == Items.ELYTRA) {
            ...
            if (dye != EnumDyeColor.WHITE)
                event.getToolTip().add(I18n.format("neutronia_legacy.dyedElytra", I18n.format("neutronia_legacy.dye." + dye.getTranslationKey())));
        }
    }
