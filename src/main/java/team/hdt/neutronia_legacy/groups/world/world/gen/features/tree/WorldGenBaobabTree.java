...
public class WorldGenBaobabTree extends WorldGenHugeTrees {
    private static final IBlockState LOG = BaobabTrees.baobabLog.getDefaultState();

    private static final IBlockState LEAF = BaobabTrees.baobabLeaves.getDefaultState()
