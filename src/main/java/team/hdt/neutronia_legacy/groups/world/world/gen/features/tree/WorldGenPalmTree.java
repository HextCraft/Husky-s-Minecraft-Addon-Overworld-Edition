...
public class WorldGenPalmTree extends WorldGenAbstractTree {
    private static final IBlockState LOG = PalmTrees.palmLog.getDefaultState();

    private static final IBlockState LEAF = PalmTrees.palmLeaves.getDefaultState()
            .withProperty(BlockPVJLeaves.CHECK_DECAY, Boolean.FALSE);

    private static final IBlockState COCONUT = PalmTrees.coconut.getDefaultState();
            ...
            if (!flag) {
                ...
                boolean isSoil = state.getBlock()
                        .canSustainPlant(state, worldIn, down, net.minecraft.util.EnumFacing.UP,
                                (BlockPVJSapling) PalmTrees.palmSapling)
