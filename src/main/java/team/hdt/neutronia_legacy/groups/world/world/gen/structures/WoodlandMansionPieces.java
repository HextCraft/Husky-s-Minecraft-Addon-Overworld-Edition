package team.hdt.neutronia_legacy.groups.world.world.gen.structures;
...
public class WoodlandMansionPieces
{
    ...
    static class Grid
        {
            ...
            @Nullable
            public EnumFacing get1x2RoomDirection(int p_191113_2_, int p_191113_3_, int p_191113_4_, int p_191113_5_)
            {
                for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL.facings())
                {
                    if (this.isRoomId(p_191113_2_ + enumfacing.getXOffset(), p_191113_3_ + enumfacing.getZOffset(), p_191113_4_, p_191113_5_))
                    {
                        return enumfacing;
                    }
                }
            ...
            private void setupThirdFloor()
            {
                ...
                else
                {
                    ...
                    EnumFacing enumfacing1 = this.get1x2RoomDirection(tuple.getFirst().intValue(), tuple.getSecond().intValue(), 1, l1 & 65535);
    ...
    public static class MansionTemplate extends StructureComponentTemplate
        {
            private String templateName, woodType;
            ...
            public MansionTemplate(TemplateManager templateManager, String name, String woodType, BlockPos pos, Rotation rotation)
            {
                this(templateManager, name, woodType, pos, rotation, Mirror.NONE);
            }

            public MansionTemplate(TemplateManager templateManager, String templateName, String woodType, BlockPos blockPos, Rotation rotation, Mirror mirror)
            {
                super(0);
            ...
            public MansionTemplate(TemplateManager templateManager, String name, BlockPos pos, Rotation rotation)
            {
                this(templateManager, name, pos, rotation, Mirror.NONE);
            }

            public MansionTemplate(TemplateManager templateManager, String templateName, BlockPos blockPos, Rotation rotation, Mirror mirror)
            {
                super(0);
                this.templateName = templateName;
                this.templatePosition = blockPos;
            ...
            {
                Template template = p_191081_1_.getTemplate(null, new ResourceLocation("neutronia_legacy","mansion/" + /*this.woodType + "_" + */this.templateName));
                    ...
                    for (int k1 = 0; k1 < woodlandmansionpieces$simplegrid3.height; ++k1)
                    {
                        for (int l1 = 0; l1 < woodlandmansionpieces$simplegrid3.width; ++l1)
                        {
                            ...
                            if (woodlandmansionpieces$simplegrid3.get(l1, k1) == 2 || flag1)
                            {
                                ...
                                if (WoodlandMansionPieces.Grid.isHouse(woodlandmansionpieces$simplegrid3, l1 - 1, k1) && !p_191125_4_.isRoomId(l1 - 1, k1, l2, k2))
                                {
                                ...
                                if (WoodlandMansionPieces.Grid.isHouse(woodlandmansionpieces$simplegrid3, l1, k1 + 1) && !p_191125_4_.isRoomId(l1, k1 + 1, l2, k2))
                                {
                                ...
                                {
                                    EnumFacing enumfacing3 = p_191125_4_.get1x2RoomDirection(l1, k1, l2, k2);
                                ...
                                else if (j2 == 262144 && enumfacing1 != null && enumfacing1 != EnumFacing.UP)
                                {
                                    ...
                                    if (!p_191125_4_.isRoomId(l1 + enumfacing2.getXOffset(), k1 + enumfacing2.getZOffset(), l2, k2))
                                    {
