...
public class VariedDungeons extends Component {
    ...
    public void placeDungeonAt(WorldServer world, Random rand, BlockPos position) {
        ...
        Template template = world.getStructureTemplateManager().getTemplate(server, new ResourceLocation("neutronia_legacy", "dungeon_" + dungeonType));
                ...
                if (tile instanceof TileEntityMobSpawner) {
                    if (Loader.isModLoaded("dungeontweaks")) {
                        try {
                            ...
                            Event event = constructor.newInstance(tile, tile.getPos(), world.rand, new ResourceLocation("neutronia_legacy:dungeon"), world);
