...
import team.hdt.neutronia_legacy.groups.world.features.overworld.Stalagmite;
...
public class StalagmiteGenerator implements IWorldGenerator {
    ...
    private Block getStalagmiteType(IBlockState state) {
        ...
        if (block == Blocks.NETHERRACK)
            ...
            return Stalagmite.clay_stalagmite;
        else if (block == Blocks.END_STONE)
            return Stalagmite.end_stalagmite;
        else if (block == Blocks.DIRT)
            return Stalagmite.dirt_stalagmite;
        else if (block == Blocks.SANDSTONE)
            return Stalagmite.sandstone_stalagmite;
