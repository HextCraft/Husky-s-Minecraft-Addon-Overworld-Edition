...
public class WorldGenWillowTree extends WorldGenAbstractTree {
    private static final IBlockState LOG = WillowTree.willowLog.getDefaultState();
    private static final IBlockState LEAVES = WillowTree.willowLeaves.getDefaultState();
