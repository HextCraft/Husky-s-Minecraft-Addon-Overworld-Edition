...
public class BasicCaveBiome extends CaveBiome {

    IBlockState floorState, ceilingState, wallState;
    boolean mimicInside;

    public BasicCaveBiome(IBlockState floorState, IBlockState ceilingState, IBlockState wallState) {
        this(floorState, ceilingState, wallState, false);
    }

    public BasicCaveBiome(IBlockState floorState, IBlockState ceilingState, IBlockState wallState, boolean mimicInside) {
