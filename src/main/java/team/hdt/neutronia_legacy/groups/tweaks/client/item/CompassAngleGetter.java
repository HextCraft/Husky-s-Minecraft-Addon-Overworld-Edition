...
import team.hdt.neutronia_legacy.groups.tweaks.features.CompassesWorkEverywhere;
...
public class CompassAngleGetter implements IItemPropertyGetter {
    ...
    private static final String TAG_CALCULATED = "neutronia_legacy:compass_calculated";
    private static final String TAG_WAS_IN_NETHER = "neutronia_legacy:compass_in_nether";
    private static final String TAG_POSITION_SET = "neutronia_legacy:compass_position_set";
    private static final String TAG_NETHER_TARGET_X = "neutronia_legacy:nether_x";
    private static final String TAG_NETHER_TARGET_Z = "neutronia_legacy:nether_z";
