...
public class StairsMakeMore extends Component {
    ...
    public void postPreInit(FMLPreInitializationEvent event) {
        if (enableSlabToStair)
            slabMultiRecipe = new MultiRecipe(new ResourceLocation("neutronia_legacy", "slabs_to_stairs"));
        if (reversionRecipe)
            returnMultiRecipe = new MultiRecipe(new ResourceLocation("neutronia_legacy", "stairs_to_blocks"));
    }
