...
import team.hdt.neutronia_legacy.groups.decoration.features.VariedChests;
import team.hdt.neutronia_legacy.groups.decoration.items.ItemChestBlock;
...
public class BlockCustomChest extends BlockChest implements INeutroniaBlock {
    ...
    public BlockCustomChest(String name, Type type) {
        ...
        setCreativeTab(type == VariedChests.CUSTOM_TYPE_NEUTRONIA_TRAP ? CreativeTabs.REDSTONE : CreativeTabs.DECORATIONS);
    }
    ...
    public boolean canProvidePower(IBlockState state) {
        return chestType == VariedChests.CUSTOM_TYPE_NEUTRONIA_TRAP;
    }
