/*
package team.hdt.neutronia_legacy.groups.decoration.tile_entity;
...
public class TileEntityCampfire extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    public static int getItemBurnTime(ItemStack stack)
    {
        ...
        else
        {
            ...
            {
            	if(((BlockGroundCover)Block.getBlockFromItem(item)).getGroundcoverType() == BlockGroundCover.GroundCoverType.TWIGS)
            	{
                	return 100;
            	}
            }
