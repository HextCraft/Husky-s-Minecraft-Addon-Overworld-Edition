...
import team.hdt.neutronia_legacy.groups.decoration.blocks.BlockCustomChest;
import team.hdt.neutronia_legacy.groups.decoration.client.render.RenderTileCustomChest;
import team.hdt.neutronia_legacy.groups.decoration.tile_entity.TileCustomChest;
...
//		OreDictionary.registerOre("chest", ProxyRegistry.newStack(custom_chest_trap, 1, OreDictionary.WILDCARD_VALUE));
    ...
    public enum ChestType {
        ...
        ChestType(String name) {
            ...
            normalModel = new ModelResourceLocation(new ResourceLocation("neutronia_legacy", "wooden_chest"), "inventory");
            trapModel = new ModelResourceLocation(new ResourceLocation("neutronia_legacy", "trapped_wooden_chest"), "inventory");
        }
