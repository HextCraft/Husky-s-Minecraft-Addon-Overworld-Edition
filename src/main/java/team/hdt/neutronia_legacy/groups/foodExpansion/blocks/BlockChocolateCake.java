package team.hdt.neutronia_legacy.groups.foodExpansion.blocks;
...
public class BlockChocolateCake extends BlockNeutroniaBase {

    private static final PropertyInteger BITES = PropertyInteger.create("bites", 0, 6);
    ...
    public BlockChocolateCake() {
        super(Material.CAKE, "chocolate_cake");
