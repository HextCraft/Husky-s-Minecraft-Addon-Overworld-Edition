package team.hdt.neutronia_legacy.groups.misc.recipe;

import team.hdt.huskylib.recipe.ModRecipe;
...
import team.hdt.neutronia_legacy.groups.misc.feature.MapMarkers;
...
public class MapPinningRecipe extends ModRecipe {
    ...
    public MapPinningRecipe() {
        super(new ResourceLocation("neutronia_legacy", "map_pinning"));
    }
