package team.hdt.neutronia_legacy.groups.dimensions.world.gen.overworld;
...
public class OWChunkGenerator implements IChunkGenerator {
    ...
    private double[] depthBuffer = new double[512];
    ...
    public OWChunkGenerator(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions) {
        {
        ...
        this.surfaceNoise = new NoiseGeneratorPerlin(this.rand, 8);
        this.scaleNoise = new NoiseGeneratorOctaves(this.rand, 20);
